...
enum {
	...
	DISP_REG_OVL_INTEN   = (DISPSYS_OVL_BASE + 0x0004),
	DISP_REG_OVL_INTSTA  = (DISPSYS_OVL_BASE + 0x0008),
...
static int mt8173_display_init(DisplayOps *me)
{
	...
	writel(0x0f, (void *)(uintptr_t)DISP_REG_OVL_INTEN);
	return 0;
}

/* Turn on or turn off the backlight */
static int mt8173_backlight_update(DisplayOps *me, uint8_t enable)
{
	/* TODO : enable backlight with GPIO */
	return 0;
}
...
{
	/* Disable overlayer 0 */
	writel(0x00, (void *)(uintptr_t)DISP_REG_OVL_INTEN);
	writel(0x00, (void *)(uintptr_t)DISP_REG_OVL_EN);
	writel(0x00, (void *)(uintptr_t)DISP_REG_OVL_INTSTA);
...
static DisplayOps mt8173_display_ops = {
	...
	.backlight_update = &mt8173_backlight_update,
