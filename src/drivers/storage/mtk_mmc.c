        ...
        MmcCommand *cmd, MmcData *data)
{
	...
	rawcmd.full = 0;
	rawcmd.cmd = opcode & 0x3F;
	rawcmd.rsptype = resp & 7;
                                 ...
                                 struct bounce_buffer *bbstate)
{
	...
	setbits_le32(&reg->dma_ctrl, MSDC_DMA_CTRL_LASTBUF);
	clrbits_le32(&reg->dma_ctrl, MSDC_DMA_CTRL_MODE);
}
...
static int mtk_mmc_init(BlockDevCtrlrOps *me)
{
	...
	clrbits_le32(&reg->msdc_inten, readl(&reg->msdc_inten));
